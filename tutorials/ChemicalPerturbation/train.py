...
import cellot_model.train
from cellot_model.train.experiment import prepare
...
def main(argv):
    ...
    if config.model.name == "cellot":
        train = cellot_model.train.train_cellot

    elif config.model.name == "scgen" or config.model.name == "cae":
        train = cellot_model.train.train_auto_encoder
