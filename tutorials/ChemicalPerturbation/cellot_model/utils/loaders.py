import cellot_model.models
from cellot_model.data.cell import load_cell_data
...
def load_model(config, restore=None, **kwargs):
    ...
    if name == "cellot":
        loadfxn = model.models.load_cellot_model

    elif name == "scgen":
        loadfxn = model.models.load_autoencoder_model

    elif name == "cae":
        loadfxn = model.models.load_autoencoder_model

    elif name == "popalign":
        loadfxn = model.models.load_popalign_model
